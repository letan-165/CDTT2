...
public enum ErrorCode {
    ROLE_INVALID(1003,"Lỗi vai trò người dùng (role) không hợp lệ", HttpStatus.BAD_REQUEST),
    PASSWORD_LOGIN_FAIL(1003,"Lỗi người dùng (user) đăng nhập sai mật khẩu", HttpStatus.BAD_REQUEST),
    USER_EXIST(1003,"Lỗi người dùng (user) đã tồn tại trong hệ thống", HttpStatus.BAD_REQUEST),
