...
class SaveActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnBackToCourse: Button = findViewById(R.id.btn_back_to_course)

        // 13. từ trang activity_save bấm quay lại khóa học thì sang trang activity_see_score
        btnBackToCourse.setOnClickListener {
            val intent = Intent(this, SeeScoreActivity::class.java) // SeeScoreActivity = activity_see_score
            startActivity(intent)
            finish() // Kết thúc SaveActivity
        }
