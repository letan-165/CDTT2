...
class QuizQuestions3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 10. từ trang activity_quiz_questions3 bấm câu tiếp thì sang trang activity_quiz_questions4
        btnNextQuestion.setOnClickListener {
            val intent = Intent(this, QuizQuestions4Activity::class.java)
            startActivity(intent)
        }

        // 10. ...bấm câu trước thì quay lại trang activity_quiz_questions2
        btnPreviousQuestion.setOnClickListener {
            finish() // Kết thúc activity hiện tại để quay lại activity_quiz_questions2
        }
